 ...
 * So test different matrix sizes by changing these */

#define DIM_N      2    // The n dimension (height of A and C)
#define DIM_M      2    // The m dimension (width of A and height of B)
#define DIM_P      2    // The p dimension (width of B and C)
